...
# set images path
train_path = 'D:\\Chris\\我的文件\\CSE598\\Project\\dog-breed-identification\\train'
test_path = 'D:\\Chris\\我的文件\\CSE598\\Project\\dog-breed-identification\\test'


# Read the csv files
train_labels = pd.read_csv('D:\\Chris\\我的文件\\CSE598\\Project\\dog-breed-identification\\labels.csv')
test_labels = pd.read_csv('D:\\Chris\\我的文件\\CSE598\\Project\\dog-breed-identification\\sample_submission.csv')
...
# input_image = load('D:\\Chris\\我的文件\\CSE598\\Project\\dog-breed-identification\\test\\00c14d34a725db12068402e4ce714d4c.jpg')
